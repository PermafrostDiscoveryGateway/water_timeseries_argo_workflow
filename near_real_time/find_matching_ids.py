...
def main():
    ...
    for region in all_regions:
        if env_path:
            matching_ids = find_matching_lake_ids(region=region, analysis_date=date_to_run, env_path=env_path)
        else:
            matching_ids = find_matching_lake_ids(region=region, analysis_date=date_to_run)
