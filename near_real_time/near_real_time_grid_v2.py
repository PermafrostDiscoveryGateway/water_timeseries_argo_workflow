...
# remove any breakpoint calculation, or dealing with breakpoint results
# just download and then, merge the final results, making sure to create the new netcdf file
def download_near_real_time_region(region: str = "TEST", run_start_label: str = None, env_path: str = None):
    ...
    This function only handles downloading and merging data into the historical NetCDF file.
    No breakpoint calculation is performed here.
