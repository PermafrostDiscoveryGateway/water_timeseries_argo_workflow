...
def main():
    ...
    parser.add_argument('--source_bucket',
                        ...
                        default="pdg-storage-default")
    parser.add_argument('--gcp_project',
                        help='Google Cloud Project ID',
                        default="pdg-project-406720")
    parser.add_argument('--gcs_subfolder_path',
                        help='Path to subfolder in the bucket',
                        default="workflows_optimization/lake_change_detection")
    parser.add_argument('--local_path',
                        help='Local directory path to download to',
                        default="/mnt/argo-filestore/water_timeseries/dynamic_world_data")
